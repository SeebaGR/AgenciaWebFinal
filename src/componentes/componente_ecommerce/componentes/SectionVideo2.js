  ...
  return (
    <div id="video2d" className="padd-padd" style={{ paddingTop: "40px", paddingBottom: "40px", background: props.colorFondo }}>
      ...
      {show ? (
           ...
           >
<img loading="lazy"  className="ol-mg img-fluid" alt="olas" width="100%" src="https://cdn.shopify.com/s/files/1/0654/9366/3973/files/portada_video_min_51e38f220d.jpg?v=1658864218"></img>
