    ...
    <div  className="cont-mov" style={{ backgroundColor: "white", paddingTop:"60px", paddingBottom:"60px" }}>
      <Container  >
        ...
        >
          ...
          <h1 className="parru-mkt3">Hemos administrado más de 25 millones de dólares en pauta publicitaria y hemos asesorado a +800 ecommerce en la implementación de campañas de marketing digital con foco a performance.</h1>
      ...
      style={{paddingTop:"1%"}}
        ...
        src="https://cdn.shopify.com/s/files/1/0610/5648/3573/files/ALN-JULIO-SEM04-COLLAGE1_1_9d93c6e9-d18d-4723-b4a5-a9da2f2d948d.png?v=1729198663"
      ></img>
