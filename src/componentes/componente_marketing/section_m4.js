  ...
  return (
    <div  >
        ...
        >
          ...
          <p className="pc-for parrafoEmbudo primerParfLeft2">Hemos asesorado a +800 empresas en la<br /> implementación de campañas en Facebook e<br /> Instagram Ads, Google Ads, Youtube Ads, Email<br /> Marketing, Analitica Web y Performance</p>
          <h2 className="movil-for primerParfLeft">CON LA IMPLEMENTACIÓN DE CAMPAÑAS DE MARKETING DIGITAL</h2>
          <p className="pdtwot  movil-for primerParfLeft2">Hemos asesorado a +800 empresas en la implementación de campañas en Facebook e Instagram Ads, Google Ads, Youtube Ads, Email Marketing, Analitica Web y Performance</p>
