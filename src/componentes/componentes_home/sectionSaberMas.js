...
<p className="parrafoSaber">Aprovechamos las posibilidades que el mundo online hoy nos ofrece para sacar el máximo provecho a la tecnología.</p>
  ...
  <img  alt="" src={data.imagen_titulo[0].url} style={{paddingTop:"40px",}} className="lazyload img img-fluid imagenes-esconder" ></img>
      <Container className="contenedor-body9">
        ...
        >
          <Col id="saberMas2"  sm={3}><a  href="https://www.fbadschile.cl/"><img width={242} height={360}  src={data.img_nosotros[0].url}  alt="" className="hoverclas img-fluid"></img></a></Col>
          <Col id="saberMas2" sm={3}><a href="https://www.matiasvillanueva.com/"><img width={242} height={360} src={data.img_nosotros[1].url} alt="" className="hoverclas img-fluid"></img></a></Col>
          <Col sm={3}><a href="https://www.academiametrics.com/"><img width={242} height={360} src={data.img_nosotros[2].url}  alt=""className="hoverclas img-fluid"></img></a></Col>
          <Col sm={3}><a href="https://www.autodidactasdigitales.com/"><img width={242} height={360} src={data.img_nosotros[3].url} alt="" className="hoverclas img-fluid"></img></a></Col>
        </Row>
      </Container>
    </div>
  );
